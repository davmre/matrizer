...
fakeTree :: Expr
fakeTree = Let "C" (Branch2 MSum (Leaf "A") (Leaf "B") ) False (Branch2 MProduct (Branch2 MProduct (Leaf "A") (Leaf "C") ) (Leaf "x"))
...
treeMatrix (Let lhs rhs tmp body) tbl = do letMatrix <- treeMatrix rhs tbl
