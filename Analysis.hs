...
treeMatrix (Branch2 MLinSolve t1 t2) tbl = updateMatrixBinaryOp linsolveSizeCheck linsolveNewSize MLinSolve t1 t2 tbl
...
updateBinaryProps MLinSolve props1 props2 = updateBinaryClosedProps [] props1 props2
